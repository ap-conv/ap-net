...
data_set['train'] = dataset(cfg,imgroot=rawdata_root,anno_pd=train_pd,
                       aug_1=data_transforms["aug_1"],aug_2=data_transforms["aug_2"],totensor=data_transforms["totensor"],train=True
                       )
data_set['val'] = dataset(cfg,imgroot=rawdata_root,anno_pd=test_pd,
                       aug_1=data_transforms["None"],aug_2=data_transforms["None"],totensor=data_transforms["valtotensor"],train=False
                       )
dataloader = {}
